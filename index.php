...
require_once($CFG->dirroot.'/admin/tool/dbcleaner/lib.php');
require_once($CFG->dirroot.'/admin/tool/dbcleaner/index.controller.php');
...
echo '<center>';
echo $OUTPUT->single_button(new moodle_url('/admin/tool/dbcleaner/process.php', array('confirm' => 0, 'sesskey' => sesskey())), get_string('process', 'tool_dbcleaner'));
echo '</center>';
